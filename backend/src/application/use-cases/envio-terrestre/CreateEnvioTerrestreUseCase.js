/**
 * Caso de Uso: Crear Envío Terrestre
 * Implementa la lógica de negocio para crear un envío terrestre
 */
export class CreateEnvioTerrestreUseCase {
  constructor(
  ...
  async execute(envioData) {
    ...
    const envio = new EnvioTerrestre(envioData);
    ...
    // Persistir
    return await this.envioTerrestreRepository.create(envio);
  }
}
